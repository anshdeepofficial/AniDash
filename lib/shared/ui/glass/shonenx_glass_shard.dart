...
import 'package:ani_dash/shared/ui/glass/shonenx_glass_painter.dart';

class AniDashGlassShard extends StatelessWidget {
  final Widget child;
  ...
  factory AniDashGlassShard.network({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      painter: AniDashGlassRimPainter(radius: borderRadius, isDark: isDark),
      child: ClipRRect(
