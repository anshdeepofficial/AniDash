...
class KaidoProvider extends AnimeProvider {
  ...
  Future<BaseServerModel> getSupportedServers({dynamic metadata}) async {
    return BaseServerModel(
      sub: [
        ServerData(id: 'vidcloud', name: 'Vidcloud', isDub: false),
        ServerData(id: 'vidstreaming', name: 'Vidstreaming', isDub: false),
      ],
      dub: [
        ServerData(id: 'vidcloud', name: 'Vidcloud', isDub: true),
        ServerData(id: 'vidstreaming', name: 'Vidstreaming', isDub: true),
      ],
    );
  }
