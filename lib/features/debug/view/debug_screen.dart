...
import 'package:ani_dash/features/debug/view/commentum_debug_screen.dart';
import 'package:ani_dash/features/debug/view/inappwebview_debug_screen.dart';
import 'package:ani_dash/features/debug/view/renderer_debug_screen.dart';
          ...
          SettingsSection(
            ...
            children: [
              ...
              NormalSettingsItem(
                ...
                icon: Icon(Icons.code, color: colorScheme.primary),
                accent: colorScheme.primary,
                description: 'Debugger for renderer',
                onTap: () => Navigator.of(context).push(
                  MaterialPageRoute(
